...
const allButtons = document.getElementById("buttonContainer");
...
//displays buttons
const buttons = () => {
  const domString = `<button type="button" class="btn btn-primary" id="all">All</button>
